...
if ( ! class_exists( 'CSCO_Customizer_Fonts' ) ) {
	...
	final class CSCO_Customizer_Fonts {
		...
		public static function get_all_variants() {
			return array(
				'100'       => esc_html__( 'Ultra-Light 100', 'caards' ),
				'100light'  => esc_html__( 'Ultra-Light 100', 'caards' ),
				'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'caards' ),
				'200'       => esc_html__( 'Light 200', 'caards' ),
				'200italic' => esc_html__( 'Light 200 Italic', 'caards' ),
				'300'       => esc_html__( 'Book 300', 'caards' ),
				'300italic' => esc_html__( 'Book 300 Italic', 'caards' ),
				'400'       => esc_html__( 'Normal 400', 'caards' ),
				'regular'   => esc_html__( 'Normal 400', 'caards' ),
				'italic'    => esc_html__( 'Normal 400 Italic', 'caards' ),
				'500'       => esc_html__( 'Medium 500', 'caards' ),
				'500italic' => esc_html__( 'Medium 500 Italic', 'caards' ),
				'600'       => esc_html__( 'Semi-Bold 600', 'caards' ),
				'600bold'   => esc_html__( 'Semi-Bold 600', 'caards' ),
				'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'caards' ),
				'700'       => esc_html__( 'Bold 700', 'caards' ),
				'700italic' => esc_html__( 'Bold 700 Italic', 'caards' ),
				'800'       => esc_html__( 'Extra-Bold 800', 'caards' ),
				'800bold'   => esc_html__( 'Extra-Bold 800', 'caards' ),
				'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'caards' ),
				'900'       => esc_html__( 'Ultra-Bold 900', 'caards' ),
				'900bold'   => esc_html__( 'Ultra-Bold 900', 'caards' ),
				'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'caards' ),
			);
		}
