	...
	class CSCO_Customizer {
		...
		public function customizer_controls_enqueue_scripts() {
			...
			wp_localize_script( 'csco-customizer', 'cscoCustomizerConfig', array(
				...
				'advanced_settings'    => esc_html__( 'Advanced settings', 'caards' ),
				'noFileSelected'       => esc_html__( 'No File Selected', 'caards' ),
				'remove'               => esc_html__( 'Remove', 'caards' ),
				'default'              => esc_html__( 'Default', 'caards' ),
				'selectFile'           => esc_html__( 'Select File', 'caards' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'caards' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'caards' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'caards' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'caards' ),
			) );
