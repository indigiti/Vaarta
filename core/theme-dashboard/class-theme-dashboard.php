...
if ( ! class_exists( 'CSCO_Theme_Dashboard' ) ) {
	...
	class CSCO_Theme_Dashboard {
		...
		public function add_menu_page() {
			add_submenu_page( 'themes.php', esc_html__( 'Theme Dashboard', 'caards' ), esc_html__( 'Theme Dashboard', 'caards' ), 'manage_options', $this->menu_slug, array( $this, 'render_page' ), 1 );
		}
		...
		public function set_settings( $settings ) {
			...
			$this->settings['hero_title'] = sprintf( esc_html__( 'Welcome to %1$s', 'caards' ), $theme->get('Name') );
			/* translators: Theme Name */
			$this->settings['hero_desc']  = sprintf( esc_html__( '%1$s is now installed and activated. To help you with the next step, we\'ve gathered together on this page all the resources you might need. We hope you enjoy using this theme.', 'caards' ), $theme->get('Name') );
		...
		public function render_hero( $location = null ) {
			...
			<div class="cs-hero">
				<div class="cs-hero-content">
					...
					<?php } else { ?>
						<div class="cs-hero-desc">
							<?php echo esc_html( $theme->get( 'Name' ) ); ?> <?php esc_html_e( 'is now installed and ready to go. Please', 'caards' ); ?> <a href="<?php echo esc_url( admin_url( '/themes.php?page=theme-dashboard&tab=license' ) ); ?>"><?php esc_html_e( 'activate your license', 'caards' ); ?></a> <?php esc_html_e( 'to enable theme demos.', 'caards' ); ?>
						</div>
					<?php } ?>

					<?php if ( csco_get_license_data( 'status' ) ) { ?>
						<a href="<?php echo esc_url( admin_url( '/themes.php?page=theme-demos' ) ); ?>" class="cs-hero-go button button-primary">
							<?php esc_html_e( 'Go to Theme Demos', 'caards' ); ?>
						</a>
					<?php } ?>
				</div>
		...
		public function render_page() {
			...
			<div class="cs-wrap cs-theme-dashboard">
				<div class="cs-header">
					...
					<div class="cs-header-right">
						<a href="<?php echo esc_url( $this->settings['documentation_link'] ); ?>" class="cs-link-documentation" target="_blank">
							<span><?php esc_html_e( 'Documentation', 'caards' ); ?></span>
				...
				<div class="wrap">
					...
					<h1 class="hidden"><?php esc_html_e( 'Theme Dashboard', 'caards' ); ?></h1>
						...
						<div class="cs-main-sidebar">
							<div class="cs-panel cs-panel-changelog">
								<div class="cs-panel-head">
									<h3 class="cs-panel-title"><?php esc_html_e( 'Changelog', 'caards' ); ?></h3>
								</div>
								<div class="cs-panel-content">
									<div class="cs-description"><?php esc_html_e( 'Keep informed with the latest changes about each theme.', 'caards' ); ?></div>

									<a href="<?php echo esc_url( $this->settings['changelog_link'] ); ?>" class="cs-changelog-link" target="_blank">
										<?php echo esc_html_e( 'See the Changelog', 'caards' ); ?>
									</a>
								</div>
							</div>
							...
							<div class="cs-panel cs-panel-support">
								<div class="cs-panel-head">
									<h3 class="cs-panel-title"><?php esc_html_e( 'Support', 'caards' ); ?></h3>
								</div>
								<div class="cs-panel-content">
									<div class="cs-content-primary">
										<div class="cs-title">
											<?php echo esc_html__( 'Need help? We\'re here for you!', 'caards' ); ?>
										</div>

										<div class="cs-description"><?php esc_html_e( 'Have a question? Hit a bug? Get the help you need, when you need it from our friendly support staff.', 'caards' ); ?></div>

										<div class="cs-button-wrap">
											<a href="<?php echo esc_url( $this->settings['support_link'] ); ?>" class="cs-button button" target="_blank">
												<?php echo esc_html_e( 'Get Support', 'caards' ); ?>
											</a>
										</div>
									</div>
								</div>
							...
							<div class="cs-panel cs-panel-community">
								<div class="cs-panel-head">
									<h3 class="cs-panel-title"><?php esc_html_e( 'Community', 'caards' ); ?></h3>
								</div>
								<div class="cs-panel-content">
									<div class="cs-title">
										<?php echo esc_html__( 'Join our Facebook community', 'caards' ); ?>
									</div>

									<div class="cs-description"><?php esc_html_e( 'Discuss products and ask for community support or help the community.', 'caards' ); ?></div>

									<div class="cs-button-wrap">
										<a href="<?php echo esc_url( $this->settings['community_link'] ); ?>" class="cs-button button" target="_blank">
											<?php echo esc_html_e( 'Join Now', 'caards' ); ?>
										</a>
									</div>
								</div>
							</div>
