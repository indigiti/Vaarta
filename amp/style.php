...
.amp-wp-comments-link a {
	font-family: <?php echo wp_kses( $font_family, 'csco' ); ?>;
...
.amp-wp-article-content .wp-block-image.is-style-rounded amp-img,
.amp-wp-article-content .wp-block-image .is-style-rounded amp-img {
	border-radius: 0;
}
...
#amp-mobile-version-switcher > a {
	font-family: <?php echo wp_kses( $font_family, 'csco' ); ?>;
	font-weight: <?php echo ( isset( $font_primary['font-weight'] ) && $font_primary['font-weight'] ) ? esc_attr( $font_primary['font-weight'] ) : '400'; ?>;
	font-style: <?php echo ( isset( $font_primary['font-style'] ) && $font_primary['font-style'] ) ? esc_attr( $font_primary['font-style'] ) : 'normal'; ?>;
	font-size: 12px;
	padding: 5px 0;
}
