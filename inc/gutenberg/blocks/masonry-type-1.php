 ...
 */
function csco_canvas_register_layout_masonry_type_1( $layouts = array() ) {

	$layout = 'masonry-type-1';

	// Add new layout.
	$layouts[ $layout ] = array(
		'location'    => array(),
		'name'        => esc_html__( 'Masonry 1', 'caards' ),
			...
			array(
				array(
					...
					'output'         => array(
						...
						array(
							'reverse'       => '$ .cs-posts-area__main .cs-posts-area__masonry-col-$numb',
							'reverse_max'   => 4,
							'property'      => 'display',
							'value_pattern' => 'none',
						),
...
add_filter( 'canvas_block_layouts_canvas/posts', 'csco_canvas_register_layout_masonry_type_1' );
