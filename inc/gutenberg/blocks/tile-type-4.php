 ...
 */
function csco_canvas_register_layout_tile_type_4( $layouts = array() ) {
...
add_filter( 'canvas_block_layouts_canvas/posts', 'csco_canvas_register_layout_tile_type_4' );
