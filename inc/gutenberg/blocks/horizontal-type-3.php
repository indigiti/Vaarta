...
function csco_canvas_register_layout_horizontal_type_3( $layouts = array() ) {
	...
	$layouts[ $layout ] = array(
		'location'    => array(),
		'name'        => esc_html__( 'Horizontal 3', 'caards' ),
		...
		'fields'      => array_merge(
			...
			array(
				...
				array(
					...
					'output'         => array(
						array(
							'element'  => '$ .cs-posts-area__main .cs-entry__thumbnail',
				...
				array(
					'key'     => 'align_content',
					'label'   => esc_html__( 'Vertical Align Content', 'caards' ),
					'section' => 'general',
					'type'    => 'select',
					'default' => 'space-between',
					'choices' => array(
						'flex-start'    => esc_html__( 'Top', 'caards' ),
						'center'        => esc_html__( 'Center', 'caards' ),
						'flex-end'      => esc_html__( 'Bottom', 'caards' ),
						'space-between' => esc_html__( 'Space Between', 'caards' ),
					),
					'output'  => array(
						array(
							'element'  => '$ .cs-posts-area__main',
				...
				array(
					...
					'default' => 'half',
					'choices' => array(
						'one-fourth' => esc_html__( 'One Fourth', 'caards' ),
				...
				array(
					...
					'responsive'     => true,
					'default'        => '2.625rem',
					'default_laptop' => '2.625rem',
					'default_tablet' => '2rem',
					'default_mobile' => '1.5rem',
					'output'         => array(
						array(
