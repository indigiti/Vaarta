...
class CSCO_Mega_Menu {
										...
										<div class="cnvs-block-column-inner">
											<div>
												<div class="cnvs-block-custom-link is-style-cs-custom-link-styled" style="--cs-custom-link-text-align: right;">
													<a class="cs-custom-link" target="_self" href="<?php echo esc_url( $item->url ); ?>"><?php esc_html_e( 'View All', 'caards' ); ?></a>
												</div>
											</div>
										</div>
									</div>
	...
	public function rest_api_callback( $request ) {
		...
		// Number of posts.
		$per_page = isset( $_GET['per_page'] ) ? (int) $_GET['per_page'] : 4;  // Input var ok; sanitization ok.
